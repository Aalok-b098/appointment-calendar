...
export const getUpcommingAppointmentService = async () => {
  try {
...
export const deleteAppointmentService = async (appointmentId) => {
  try {
    const response = await axios.delete(
      `${API_BASE_URL}/api/delete-appointment/${appointmentId}`
    );
    return response.data;
  } catch (error) {
...
export const addAppointmentService = async (eventData) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/api/add-appointment`,
      eventData
    );
    return response.data;
  } catch (error) {
...
export const updateAppointmentService = async (eventId, eventData) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}/api/update-appointment/${eventId}`,
      eventData
    );
    return response.data;
  } catch (error) {
...
export const getParticularAppointmentService = async (id) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/api/appointment-details/${id}`
    );
    return response.data;
  } catch (error) {
