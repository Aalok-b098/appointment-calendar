  ...
  return (
    <div className="mx-auto max-w-[1150px] px-4">
      <div className="flex flex-col items-center">
        ...
        {!upcomingEventsList ? (<div className="border-r border-b border-l bg-gray-400 border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <p className="text-gray-700">Today has no upcoming appointments.</p></div>
        ) : (
